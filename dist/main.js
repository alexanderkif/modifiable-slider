...
/*!************************!*\
  !*** ./demo/data.json ***!
  \************************/
/*! exports provided: sliderClass, defaults, sliders, default */
/***/ (function(module) {
...
$(".".concat(dataJson.sliderClass)).modSlider();
...
function (_EventObserver) {
  ...
  _createClass(Model, [{
    key: "normalizeModel",
    value: function normalizeModel(model) {
...
var dataJson = __webpack_require__(/*! ../demo/data.json */ "./demo/data.json");

var Slider = function Slider(element) {
  _classCallCheck(this, Slider);

  element.classList.add("sliderm3");
  var model = new _Model__WEBPACK_IMPORTED_MODULE_1__["default"](element.dataset);
...
(function ($) {
  $.fn.modSlider = function () {
    var setDefaults = function setDefaults(dataset) {
      var template = {};
      Object.assign(template, dataJson.defaults);
      var data = $.extend(template, dataset);
